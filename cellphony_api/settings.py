"""
Django settings for cellphony_api project.
...
SECRET_KEY = 'django-insecure-7n2!(pmw27o8!#ks(2-m95bm_h1^$wf*(qn$j5zbrdk)kt0%ev'
...
WSGI_APPLICATION = 'cellphony_api.wsgi.application'
